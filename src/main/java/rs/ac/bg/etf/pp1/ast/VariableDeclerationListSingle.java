...
public class VariableDeclerationListSingle extends VariableDeclarationList {

    private VariableDeclaration VariableDeclaration;

    public VariableDeclerationListSingle (VariableDeclaration VariableDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VariableDeclerationListSingle(\n");
