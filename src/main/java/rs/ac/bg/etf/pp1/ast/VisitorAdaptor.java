...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(SignEpsilon SignEpsilon) { visit(); }
    public void visit(SignNegative SignNegative) { visit(); }
    public void visit(SignPositive SignPositive) { visit(); }
    public void visit(ReturnTypeVoid ReturnTypeVoid) { visit(); }
    public void visit(ReturnTypeNonVoid ReturnTypeNonVoid) { visit(); }
    public void visit(Type Type) { visit(); }
    public void visit(RelationalOperatorLessOrEqualThan RelationalOperatorLessOrEqualThan) { visit(); }
    public void visit(RelationalOperatorLessThan RelationalOperatorLessThan) { visit(); }
    public void visit(RelationalOperatorGreaterOrEqualThan RelationalOperatorGreaterOrEqualThan) { visit(); }
    public void visit(RelationalOperatorGreaterThan RelationalOperatorGreaterThan) { visit(); }
    public void visit(RelationalOperatorNotEquals RelationalOperatorNotEquals) { visit(); }
    public void visit(RelationalOperatorEquals RelationalOperatorEquals) { visit(); }
    ...
    public void visit(AdditionOperatorSubtraction AdditionOperatorSubtraction) { visit(); }
    ...
    public void visit(DesignatorStatementIntermezzo DesignatorStatementIntermezzo) { visit(); }
    public void visit(DesignatorStatementUnpackHeader DesignatorStatementUnpackHeader) { visit(); }
    ...
    public void visit(DesignatorStatementFunctionInvocation DesignatorStatementFunctionInvocation) { visit(); }
    public void visit(DesignatorStatementAssignment DesignatorStatementAssignment) { visit(); }
    public void visit(DesignatorElementAccess DesignatorElementAccess) { visit(); }
    public void visit(DesignatorMemberAccess DesignatorMemberAccess) { visit(); }
    public void visit(DesignatorIdentifier DesignatorIdentifier) { visit(); }
    ...
    public void visit(FactorFunctionInvocation FactorFunctionInvocation) { visit(); }
    ...
    public void visit(CondFactMulti CondFactMulti) { visit(); }
    ...
    public void visit(StatementListMulti StatementListMulti) { visit(); }
    public void visit(StatementElseHeader StatementElseHeader) { visit(); }
    public void visit(MaybeElseStatementEpsilon MaybeElseStatementEpsilon) { visit(); }
    public void visit(MaybeElseStatementIsElseStatement MaybeElseStatementIsElseStatement) { visit(); }
    public void visit(MaybePrintWidthEpsilon MaybePrintWidthEpsilon) { visit(); }
    ...
    public void visit(StatementForEachDesignator StatementForEachDesignator) { visit(); }
    public void visit(StatementForEachHeader StatementForEachHeader) { visit(); }
    public void visit(StatementWhileHeader StatementWhileHeader) { visit(); }
    public void visit(StatementIfElseIntermezzo StatementIfElseIntermezzo) { visit(); }
    public void visit(StatementIfElseHeader StatementIfElseHeader) { visit(); }
    ...
    public void visit(LocalVarDecl LocalVarDecl) { visit(); }
    public void visit(LocalVarDeclEpsilon LocalVarDeclEpsilon) { visit(); }
    public void visit(LocalVarDeclListMulti LocalVarDeclListMulti) { visit(); }
    public void visit(MethodDeclarationHeader MethodDeclarationHeader) { visit(); }
    ...
    public void visit(GlobalDeclarationListMulti GlobalDeclarationListMulti) { visit(); }
