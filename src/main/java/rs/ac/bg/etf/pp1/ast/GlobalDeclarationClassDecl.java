...
public class GlobalDeclarationClassDecl extends GlobalDeclaration {

    private ClassDecl ClassDecl;

    public GlobalDeclarationClassDecl (ClassDecl ClassDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("GlobalDeclarationClassDecl(\n");
