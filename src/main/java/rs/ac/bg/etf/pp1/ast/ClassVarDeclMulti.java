...
public class ClassVarDeclMulti extends ClassVarDeclList {

    private ClassVarDeclList ClassVarDeclList;
    private VarDecl VarDecl;

    public ClassVarDeclMulti (ClassVarDeclList ClassVarDeclList, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassVarDeclMulti(\n");
