...
public class LocalVarDeclListMulti extends LocalVarDeclList {

    private LocalVarDeclList LocalVarDeclList;
    private LocalVarDecl LocalVarDecl;

    public LocalVarDeclListMulti (LocalVarDeclList LocalVarDeclList, LocalVarDecl LocalVarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("LocalVarDeclListMulti(\n");
